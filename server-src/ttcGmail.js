    ...
    return new Promise(function (resolve, reject) {
        ...
        gmail.users.messages.list({
            ...
            if (err)
                ...
                var eBlasts = [];
                async.each(list_response.messages, function (email, callback) {
                    gmail.users.messages.get({ auth: auth, userId: 'me', id: email.id, format: 'full' }, function (err, api_response) {
                        if (err)
                            ...
                            if (body_found)
                                ...
                                var err_1 = 'No text body found for eBlast id: ' + api_response.id;
                                Track.Warning(err_1);
                                callback(err_1);
                            }
                        }
...
//# sourceMappingURL=ttcGmail.js.map