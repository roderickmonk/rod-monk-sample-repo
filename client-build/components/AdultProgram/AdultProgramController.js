...
app.controller("AdultProgramController", ['$scope', 'MemberService', '$modal', '$log',
function ($scope, MemberService, $modal, $log) {
	...
	MemberService.CountMembersByDecade(function (decades) {
	...
	MemberService.CountMembersByBirthMonth(function (birthmonths) {
